 ...
 * @LastEditTime: 2021-06-03 16:01:36
 * @LastEditors: 黄婷
 * @FilePath: \vue-antd-admine:\wwwroot\Vue\MisBoot\misboot-cloud-vue\src\components\TopVUI\k-portal-design\build\buildBlocks.vue
-->
<template>
	<!-- 标签页布局 -->
	<a-tabs
...
<script>
import klistItem from '../component/model/listItem';
export default {
	name: 'buildBlocks',
	props: {
		record: {
