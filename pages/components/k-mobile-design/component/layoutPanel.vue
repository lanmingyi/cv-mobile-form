 ...
 * @LastEditTime: 2021-05-21 14:06:06
 * @LastEditors: 黄婷
 * @FilePath: \misboot-cloud-topvui\src\components\TopVUI\k-portal-design\component\layoutPanel.vue
-->
<template>
	<view class="form-panel">
		...
		<u-form ref="uForm" style="height: 100%;">
			<draggable
				tag="div"
				class="draggable-box"
				style="width: 100%;"
...
export default {
	...
	data() {
		return {
			insertAllowedType: ['list', 'text', 'bar', 'pie', 'line', 'calendar', 'timeLine', 'weather', 'flowCard'],
	...
	methods: {
		...
		handleDownMerge() {
			...
			this.rightMenuSelectValue.trs[this.trIndex + 1].tds = this.rightMenuSelectValue.trs[
				this.trIndex + 1
